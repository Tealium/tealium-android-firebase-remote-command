...
public final class TealiumHelper {
    ...
    public static void initialize(Application application) {
        ...
        final Tealium.Config config = Tealium.Config.create(application, "tealiummobile", "firebase-tag", "dev");
        ...
        RemoteCommand brc = new FirebaseRemoteCommand(application);
    ...
    public static void trackScreen(Activity activity, String screenName) {
        ...
        if (instance != null) {
            ...
            data.put(DataLayer.SCREEN_NAME, screenName);
            data.put(DataLayer.SCREEN_CLASS, activity.getClass().getSimpleName());
            instance.trackView("screen_view", data);
        }
    }
